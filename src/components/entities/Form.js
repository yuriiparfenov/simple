  ...
  return (
    <div>
      <form action="#" method="POST">
        ...
        <p>
          <input type="text" name="enter" value={inputValue} onChange={e => setInputValue(e.target.value)}/>
        </p>
        <p>Выберите падеж</p>
        <p>
          <select name="case[]" value={selectValue} onChange={e => setSelectValue(e.target.value)}>
